      ...
      <div className="relative w-full bg-white px-6 py-12 shadow-xl shadow-slate-700/10 ring-1 ring-gray-900/5 md:mx-auto md:max-w-3xl lg:max-w-4xl lg:pb-28 lg:pt-16">
        <div className="mx-auto max-w-prose lg:text-lg">
          <article className="prose prose-slate mx-auto mt-8 lg:prose-lg">
            ...
            <h2>Static Rendering (Default)</h2>
            <p>
              By default, Next.js statically renders routes to improve
              performance. At build time, Server and Client components are
              rendered on the server, and the result of the work is cached and
              reused on subsequent requests.
            </p>
            <p>
              <Link href="/static-rendering">Static rendering example</Link>
            </p>
            <p>
